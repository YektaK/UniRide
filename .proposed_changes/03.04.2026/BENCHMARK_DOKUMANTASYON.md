...
6. [Güncelleme Yaparken Dikkat Edilmesi Gerekenler](#güncelleme-yaparken-dikkat-edilmesi-gerekenler)
7. [Sorun Giderme](#sorun-giderme)
8. [Genişletme Rehberi](#genişletme-rehberi)
...
4. Kullanıcı menüden seçim yapar
   ...
   [D] Kapsamlı test
           │
           ▼
5. Her problem için her strateji çalıştırılır
   - 3 farklı seed ile test
   - Ortalama ve en iyi değerler hesaplanır
           │
           ▼
...
# Kategori belirleme fonksiyonunu güncel
...
*Bu dokümantasyon 2026-04-03 tarihinde oluşturulmuştur.*
