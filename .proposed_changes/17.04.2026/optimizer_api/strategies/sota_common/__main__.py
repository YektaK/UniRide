"""Allow running ``python -m strategies.sota_common`` for smoke tests."""

from strategies.sota_common import *  # noqa: F401, F403
from strategies.sota_common.__init__ import SOTA_INFRA_VERSION  # type: ignore
...
if __name__ == "__main__":
    ...
    mod = importlib.import_module("strategies.sota_common")
