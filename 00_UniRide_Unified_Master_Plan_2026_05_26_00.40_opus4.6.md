...
Recommended next task: generate and inspect promotion-quality configs using only feasible rows, then decide whether to broaden Solomon coverage further or investigate pyvroom's Windows matrix buffer compatibility separately.
