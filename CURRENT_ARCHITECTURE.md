...
Current critical risk: an academic/coordinate path can still produce Euclidean-degree or fabricated edges, and matrix provenance (domain, units, directionality, source, hash) is not yet declared. These silently change route order, feasibility, and benchmark rankings.
