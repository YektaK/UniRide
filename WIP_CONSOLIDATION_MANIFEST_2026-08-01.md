...
- Promotion decision: **conditional hold**. Do not move WIP until (1) `archive/local-rescue-20260721` is pushed and peel-verified with workflow-scoped authentication, and (2) the Supabase-configured production build passes or the user explicitly accepts this environment waiver. Missing FastAPI JIT collection and optional OR-Tools results remain environment limitations, not green evidence.
