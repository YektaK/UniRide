...
class GeneticAlgorithmStrategy(BaseRoutingStrategy):
    ...
    DEFAULT_CONFIG = {
        ...
        "clustering_algorithm": "clarke_wright",  # Time-matrix aware clustering
    }
    ...
    def optimize(self, request: OptimizationRequest) -> OptimizationResponse:
        ...
        # Calculate vehicle assignments with time-matrix aware clustering
        clustering_algo = self.config.get("clustering_algorithm", "clarke_wright")
