...
class VehicleCalculator:
    ...
    def calculate(
        ...
        Args:
            ...
            time_matrix: Dict of dicts with travel times between locations (for time-matrix aware clustering)
            depot: Dict with depot info (id, lat, lng)
            raw_students: Original student dicts (for location codes)
        ...
        for attempt in range(max_attempts):
            # Pass time_matrix and depot for time-matrix aware clustering
            clusters = self.cluster_students(
                points, 
                num_vehicles,
                time_matrix=time_matrix,
                depot=depot,
                raw_students=raw_students or students
            )
