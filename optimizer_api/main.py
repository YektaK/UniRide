...
def list_strategies():
    ...
    recommended = ["genetic_algorithm", "pso", "gwo", "hho"]
...
def optimize_route(request: OptimizationRequest):
    ...
    Request body:
    - algorithm: Algorithm to use (genetic_algorithm, pso, gwo, hho, two_opt, greedy, etc.)
    ...
    - local_search_type: Type of local search for meta-heuristics (none, two_opt, three_opt, or_opt, hybrid)

    Algorithm-specific configs:
    - ga_config: Genetic Algorithm parameters (population_size, max_iterations, etc.)
    - pso_config: PSO parameters (swarm_size, max_iterations, etc.)
    - gwo_config: GWO parameters (population_size, max_iterations, initial_a, etc.)
    - hho_config: HHO parameters (population_size, max_iterations, initial_energy, etc.)
    - two_opt_config: Two-Opt parameters (multi_start, num_starts, etc.)
