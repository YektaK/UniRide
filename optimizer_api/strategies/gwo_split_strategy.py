...
class GWOSplitStrategy(BaseRoutingStrategy):
    """
    GWO-Split Hybrid Strategy for CVRPTW.
    ...
    def optimize(self, request: OptimizationRequest) -> OptimizationResponse:
        ...
        # Final split on best solution (alpha)
