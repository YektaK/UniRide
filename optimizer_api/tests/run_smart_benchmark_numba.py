...
Kullanım:
    ...
    python optimizer_api/tests/run_smart_benchmark_numba.py

VEYA interaktif (basit):
    cd /home/z/my-project
...
# Same-directory imports (restored from academic_benchmark/)
from utils_benchmark import get_latest_metadata, save_metadata, check_algorithms_status
...
def run_single_benchmark_task(args):
    ...
    from run_interactive_benchmark_v2_numba import (
        TSPLIBProblem, 
        run_single_test,
    )
