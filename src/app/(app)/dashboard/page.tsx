...
import { getStudentSchedule } from "@/lib/mock-database"; // Import from mock DB
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (user && user.role === "student" && user.weeklyScheduleId) {
      ...
      try {
        // Fetch schedule from mock database
        const studentSchedule = getStudentSchedule(user.weeklyScheduleId);
      ...
      setIsScheduleLoading(false); 
    } else if (!user && !authIsLoading) { // If no user and auth is done, stop schedule loading
        setIsScheduleLoading(false);
    }
  }, [user, authIsLoading]);
