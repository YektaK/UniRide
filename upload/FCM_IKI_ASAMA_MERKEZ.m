% BU PROGRAM FCM ÝLE %%% 2 AÞAMALI OLARAK %%% CLUSTER AYIRIYOR, PSO ÝLE CLUSTER MERKEZLERÝNÝ TUR ÝÇÝN SIRALIYOR
% ÇÝFTLER ÝÇÝN CLUSTER MERKEZLERÝ ARASINDA ÇÝZÝLEN DOÐRUNUN ORTA NOKTASINA
% EN YAKIN ELEMANLARI HER ÝKÝ CLUSTER DA DA BAÐLANTI ADAYI OLARAK SEÇÝYOR
...
[SEHIR_NO_FCM,X_KONUMU_FCM,Y_KONUMU_FCM]=textread('TSP.txt','%f %f %f');
data = [X_KONUMU_FCM,Y_KONUMU_FCM];
% CLUSTER_SAYISI1=input('1. AÞAMA Kaç Cluster olsun? 2-10 :');
% CLUSTER_SAYISI2=input('2. AÞAMA Kaç Cluster olsun? 2-10 :');
i=CLUSTER_SAYISI1;
colormap(lines(i));
col=lines(i);
...
case{10}
 ...
 Tur=Tur+1
uzunluk_deney(C2,DENEY)=UZUNLUK;
 end
SONUC1=uzunluk_deney;
end
SONUC2(C1,:,:)=SONUC1;
end